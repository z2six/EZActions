// MainFile: src/main/java/org/z2six/minemenuplus/Minemenuplus.java
...
public final class Minemenuplus {

    public Minemenuplus(IEventBus modBus) {
        ...
        try {
            ...
            modBus.addListener(MineMenuKeybinds::onRegisterKeyMappings);
