...
/** Separate config for radial look & feel (config/minemenuplus/radial.json). */
public final class RadialConfig {
    ...
    private static Path file() {
        try {
            ...
            return game.resolve("config").resolve("minemenuplus").resolve("radial.json");
        } catch (Throwable t) {
            return Path.of("config", "minemenuplus", "radial.json");
        }
    }
}
