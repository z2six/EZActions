...
public final class CategoryEditScreen extends EzScreen {
    ...
    protected void init() {
        ...
        int checksY = y + 42;
        hideFromMainCheckbox = new Checkbox(
                bodyX + 12, checksY, bodyW - 24, 20,
                Component.translatable("ezactions.gui.bundle.hide_from_main"),
        ...
        enableKeybindCheckbox = new Checkbox(
                bodyX + 12, checksY + 24, bodyW - 24, 20,
                Component.translatable("ezactions.gui.bundle.enable_keybind"),
                draftEnableKeybind
        ) {
            @Override
            public void onPress() {
    ...
    private void onSavePressed() {
        try {
            ...
            draftHideFromMainRadial = hideFromMainCheckbox != null && hideFromMainCheckbox.selected();
            draftEnableKeybind = enableKeybindCheckbox != null && enableKeybindCheckbox.selected();
