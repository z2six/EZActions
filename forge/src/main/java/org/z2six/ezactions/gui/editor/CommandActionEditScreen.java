...
public final class CommandActionEditScreen extends EzScreen {
    ...
    protected void init() {
        ...
        cycleCommandsBox = new Checkbox(
                bodyX, cycleY, contentW - 24, 20,
                Component.translatable("ezactions.gui.command_action.cycle_commands"),
                draftCycleCommands
        ) {
            @Override
            public void onPress() {
                super.onPress();
                draftCycleCommands = this.selected();
            }
        };
