...
public final class RadialScreenDraw {
    ...
    public static void drawRing(GuiGraphics g, Font font, int cx, int cy,
        ...
        try {
            ...
            // Center label for the currently hovered item — now uses Component
    ...
    private static void fillRingSector(GuiGraphics g, int cx, int cy,
        ...
        try {
            ...
            for (int i = 0; i <= segs; i++) {
                ...
                buf.vertex(pose, xOuter, yOuter, 0).color(r, gn, b, a).endVertex();
                buf.vertex(pose, xInner, yInner, 0).color(r, gn, b, a).endVertex();
            }
